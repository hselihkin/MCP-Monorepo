using BasicCalculatorServer.Tools;
...
if (mode == "1")
{
    ...
    string serverName = "Basic Calculator";

    var tools = new List<string> { "AddNum", "SubNum", "MulNum", "DivNum" };
    var argumentsData = new Dictionary<string, Dictionary<string, string>>
    {
        ["AddNum"] = new Dictionary<string, string>
        {
            ["a"] = "double",
            ["b"] = "double"
        },
        ["SubNum"] = new Dictionary<string, string>
        {
            ["a"] = "double",
            ["b"] = "double"
        },
        ["MulNum"] = new Dictionary<string, string>
        {
            ["a"] = "double",
            ["b"] = "double"
        },
        ["DivNum"] = new Dictionary<string, string>
        {
            ["a"] = "double",
            ["b"] = "double"
        }
    ...
    string serverDesc = "This a Basic calculator that can be used to carry out maths until primary grade school";
    ...
    foreach (var tool in available_tools)
    {
        ...
        string formattedSchema = JsonSerializer.Serialize(jsonDoc.RootElement, new JsonSerializerOptions { WriteIndented = true });
